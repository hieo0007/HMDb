    ...
    <main className="login-page">
      <section className="login-shell">
        <form className="uiverse-form" onSubmit={handleSubmit}>
          ...
          <div className="uiverse-inputForm">
            <svg
              height="20"
              viewBox="0 0 32 32"
              width="20"
          ...
          <div className="uiverse-flex-row">
            <div className="uiverse-remember">
              <input
                id="rememberMe"
                type="checkbox"
                checked={rememberMe}
            ...
            <button type="button" className="uiverse-inline-link">
              Forgot password?
            </button>
          </div>
          ...
          <button className="uiverse-button-submit" type="submit">
            Sign In
          </button>
          <p className="uiverse-p">
            Don&apos;t have an account?
            <button type="button" className="uiverse-inline-link">
              Sign Up
            </button>
          </p>
          <p className="uiverse-p uiverse-line">Or With</p>

          <div className="uiverse-flex-row uiverse-social-row">
            <button className="uiverse-btn" type="button">
              <svg
                version="1.1"
                width="20"
                xmlns="http://www.w3.org/2000/svg"
